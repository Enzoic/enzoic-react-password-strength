...
Enzoic.Sha256.hash = function(msg) {
    ...
    return Utils.toHexStr(H[0]) + Utils.toHexStr(H[1]) + Utils.toHexStr(H[2]) + Utils.toHexStr(H[3]) +
        Utils.toHexStr(H[4]) + Utils.toHexStr(H[5]) + Utils.toHexStr(H[6]) + Utils.toHexStr(H[7]);
};
